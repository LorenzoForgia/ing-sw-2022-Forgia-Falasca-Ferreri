...
public class DeckCC implements Serializable {
    ...
    public DeckCC() {
      ...
      characterCards.add(new CharacterCard5(5,2,0 ,"Piazza una tessera divieto su un'isola a tua scelta,la prima volta che madre natura termina il suo mobvimento ì rimettete la tessera divieto sulla carta senza calcolare l'influenza su quell'isola nè piazzare torri"));
      characterCards.add(new CharacterCard6(6,3,0 ,"Durante il coneteggio dell'influenza su un'isola le torri presenti non vengono calcolate."));
