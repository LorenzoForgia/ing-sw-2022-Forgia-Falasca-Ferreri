...
import it.polimi.ingsw.Client.views.GUI.CC3SceneView;
...
public class AnsCC3Msg extends AnswerMsg{
    ...
    public AnsCC3Msg(CommandMsg parent, GeneralBoard generalBoard, ArrayList<Player> players){
        super(parent);
    ...
    {
        if(Client.GUI){
            CC3SceneView c= new CC3SceneView(this);
            c.run();
        }else{
